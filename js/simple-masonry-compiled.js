...
var SimpleMasonryPrivates = new WeakMap();
/**
 * SimpleMasonry Class
...
var SimpleMasonry = (function () {
    function SimpleMasonry() {
        ...
        privateProps = SimpleMasonryPrivates.get(that);
        // overwrite defaults
    ...
    _createClass(SimpleMasonry, [{
        ...
        value: function go() {
            var that = this,
                privateProps = SimpleMasonryPrivates.get(this),
        ...
        value: function append(node) {
            var privateProps = SimpleMasonryPrivates.get(this),
